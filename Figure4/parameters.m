...
function [par]=parameters(Areas,fln,sln,wiring,hierVals,delta,Gext)
...
sig=0*0.01.*[1 1 0 0 0 0]; %noise on r1 and r2
...
%The deviation is assumed to be proportional to SLN, and for this set of simulations,
%we introduce a control parameter delta:
%delta=1.; %0 means no bias, 1 means 'full' bias. It's an external parameter.
