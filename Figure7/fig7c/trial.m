...
function [rate,totalinput2,totalinput3]=trial(lesionarea,par,Iext,Nareas,Tpulse)
...
Input0=zeros(3,Nareas);Input0(1,1)=0.4; %selective visual input
...
% suppression:
  ...
  if lesionarea>0
      ...
      iratenew(1:6,[16 17])=0;
  end
  
  %lesion after reaching the WM:
  if time>=10 && lesionarea==-1
      j=22;iratenew(1:6,j)=0; %LIP after WM
  end
